...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast<QString*>(_v) = _t->lastNickname(); break;
        case 1: *reinterpret_cast<QString*>(_v) = _t->lastServerUrl(); break;
    ...
    if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setLastNickname(*reinterpret_cast<QString*>(_v)); break;
        case 1: _t->setLastServerUrl(*reinterpret_cast<QString*>(_v)); break;
